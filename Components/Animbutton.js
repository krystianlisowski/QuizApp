    ...
    render() {
      return (
        <TouchableWithoutFeedback onPress={() => this._onPress()}>
          <Animatable.View ref="view" style={{     fontFamily: "Oswald-Regular"
,margin:10, paddingTop :10, paddingBottom: 10, paddingRight: 20, paddingLeft: 20, backgroundColor: this.state.status ? this.props.onColor : "#bdbdbd", borderRadius:20}}>
            <Text style={{color: this.state.status ? "white" : "#696969", fontWeight: "bold", fontFamily: 'Oswald-Regular'}}>{this.props.text}</Text>
          </Animatable.View>
        </TouchableWithoutFeedback>
      );
    }
