...
export default class Test2 extends Component {
  ...
  render() {
    ...
    return (
      <ScrollView style={{backgroundColor: '#FFBF00',paddingTop: 10}}>
      ...
      <View style={styles.oval} >
        ...
        <TouchableOpacity onPress={() => this.next()} >
          <View style={{paddingTop: 5,paddingBottom: 5, paddingRight: 20, paddingLeft: 20, borderRadius:10, backgroundColor:"#3366ff"}}>
          <Text>Next</Text>
          </View>
        </TouchableOpacity >
